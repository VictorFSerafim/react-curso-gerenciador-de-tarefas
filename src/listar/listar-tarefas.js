...
function ListarTarefas() {
    ...
    useEffect(() => {
        ...
        if (carregarTarefas) {//se não for carregado
            obterTarefas();
        ...
        <div className="text-center">
            ...
            <Table striped bordered hover responsive data-testid="tabela">
                <thead>
                    ...
                    <tr>
                        <th>
                            <Form.Control type="text" value={filtroTarefa}
                            onChange={handleFiltrar} data-testid="txt-tarefa"
            ...
            <Paginacao totalItems={totalItems} itemsPorPagina={ITENS_POR_PAG}
             paginaAtual={paginaAtual} mudarPagina={handleMudarPagina}/>
        </div>
