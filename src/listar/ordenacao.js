...
function Ordenacao(props){
    ...
    return (
        <span>
            <FontAwesomeIcon icon={faSort} className={handleAscDesc()} data-testeid="faSort"/>
            <FontAwesomeIcon icon={faSortUp} className={handleAsc()} data-testeid="faSortUp"/>
            <FontAwesomeIcon icon={faSortDown} className={handleDesc()} data-testeid="faSortDown"/>
        </span>
    );
